...
type: 'html-keyboard-response-fish',
 ...
 timeline.push(switch_to_regular_style_2, show_feedback, feedback, hide_feedback);
    ...
    var ins_16 = {
      ...
      background_spec_position: 'center center',
      choices: [32],
      prompt:'<p style="width: 80%; color: white; font-size: 30px; position: absolute; top: 6%; left: 50%; transform: translate(-50%, -6%);">You will need to fix your fishing rod to keep fishing <br> once it breaks by pressing the RIGHT button six times. <br> Press space to continue.</p>'
  }
