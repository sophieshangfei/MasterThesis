...
var ins_l_1 = {
    ...
    prompt: '<br><br><br><br><p style="color: white; font-size: 28px;"> Press space to continue with instructions.</p>',
        ...
        jsPsych.data.addProperties({index: index_trial, order: "low-high", environment: "low", price_displayed: "null", 
...
var ins_l_2 = {
    type: 'html-keyboard-response-fish',
    stimulus: '<p style="color: white; font-size: 30px;">This is Part 1 of the task. <br><br> In this part you can earn &#163;0.5 of the possible &#163;5. <br><br> You will be asked to play two rounds of the fisherman game. <br><br> Each round will last approximately 2-3 mins. <br><br><br><br><br> If you collect all &#165;3000 in this part you will be paid &#163;0.5.</p>',
    choice: [32], 
  ...
  var ins_l_3 = {
      type: 'html-keyboard-response-fish',
      stimulus: '<p style="color: white; font-size: 30px;">Please, tap throughout the task <br/> but go as fast or as slow as your want. <br><br> Remember: everytime you tap you will catch a fish, <br>but the value of that fish will change. <br><br> If your rod break press the RIGHT button 8 times to fix it. <br><br> While your rod is broken you are losing time to earn money. </p>',
      choice: [32], 
...
timeline.push(ins_l_1, ins_l_2, ins_l_3, ins_l_4);
  ...
  for(var i=0; i<n_blocks; i++){
      if (rod_series_1.includes(r_11)){
          ...
          var show_direction_l = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[t], order: "low-high", environment: "low", price_displayed: randP_1[t], 
          ...
          var fishing_l = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[t], order: "low-high", environment: "low", price_displayed: price_recorded, 
                                            round_instance: "11", task: "fishing", function_id: "fishing_l",
                                            rod_fixing_checked: "null"});
              }
          }
          ...
          var show_price_l = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[t], order: "low-high", environment: "low", price_displayed: "null", 
                                            round_instance: "11", task: "null", function_id: "caller",
                                            rod_fixing_checked: "null"});
              }
          }
    ...
    if (rod_series_2.includes(r_21)){
        // do rod
          ...
          var show_direction_l = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[g], order: "low-high", environment: "low", price_displayed: randP_2[g], 
        ...
        var fix_node_l = {
          ...
          var fishing_l = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[g], order: "low-high", environment: "low", price_displayed: price_recorded, 
                                            round_instance: "21", task: "fishing", function_id: "fishing_l",
                                            rod_fixing_checked: "null"});
              }
          }
          var loop_node_l = {
        ...
        // do fish
          ...
          var show_price_l = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[g], order: "low-high", environment: "low", price_displayed: "null", 
                                            round_instance: "21", task: "null", function_id: "caller",
                                            rod_fixing_checked: "null"});
              }
          }
...
//*****//*****//*****//*****//*****//*****//*****
 ...
 // at round 1 - rod fixing occurs at 2, 6, 10 //
  ...
  var ins_h_2 = {
      type: 'html-keyboard-response-fish',
      stimulus: '<p style="color: white; font-size: 28px;">Please, tap throughout the task </br> but go as fast or as slow as your want. <br><br> Remember: everytime you tap you will catch a fish, <br> but the value of that fish will change. <br><br> If your rod break press the RIGHT button 8 times to fix it. <br><br> While your rod is broken you are losing time to earn money. </p>',
      choice: [32], 
  ...
  timeline.push(ins_h_1, ins_h_2, ins_h_3);
    ...
    if (rod_series_1.includes(r_12)){
        ...
        var show_direction_h = {
            ...
            func: function(){
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[p], order: "low-high", environment: "high", price_displayed: randP_1[p], 
        ...
        timeline.push(switch_to_regular_style_1);
          ...
          var fishing_h = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[p], order: "low-high", environment: "high", price_displayed: price_recorded, 
        ...
        var ip = index_trial
          var show_price_h = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[p], order: "low-high", environment: "high", price_displayed: "null", 
                                            round_instance: "12", task: "null", function_id: "caller",
                                            rod_fixing_checked: "null"});
                }
          }
 ...
 // randP_2 randomized price array
  for(var i=0; i<n_blocks; i++){
    if (rod_series_2.includes(r_22)){
        ...
        var show_direction_h = {
            ...
            func: function(){
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[m], order: "low-high", environment: "high", price_displayed: randP_2[m], 
        ...
        timeline.push(switch_to_regular_style_1);
          ...
          var fishing_h = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[m], order: "low-high", environment: "high", price_displayed: price_recorded, 
        ...
        index_trial = index_trial + 1;
          var show_price_h = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({index: index_list[m], order: "low-high", environment: "high", price_displayed: "null", 
                                            round_instance: "22", task: "null", function_id: "caller",
                                            rod_fixing_checked: "null"});
                }
          }
    ...
    var calculator = {
        ...
        on_finish: function(data){
            jsPsych.data.addProperties({index: index_list[m], order: "low-high", environment: "end", price_displayed: "null", 
