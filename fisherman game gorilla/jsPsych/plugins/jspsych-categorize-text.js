...
jsPsych.plugins['categorize-text'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // display_element.innerHTML = '<div id="jspsych-categorize-text-stimulus">'+trial.stimulus+'</div>'

    // // hide image after time if the timing parameter is set
    // if (trial.stimulus_duration !== null) {
    //   jsPsych.pluginAPI.setTimeout(function() {
    //     display_element.querySelector('#jspsych-categorize-text-stimulus').style.visibility = 'hidden';
    ...
    function doFeedback(correct, timeout) {
      ...
      if (timeout && !trial.show_feedback_on_timeout) {
        ...
        if (trial.show_stim_with_feedback) {
          display_element.innerHTML = '<div id="jspsych-categorize-text-stimulus" class="jspsych-categorize-text-stimulus">'+trial.stimulus+'</div>';
        }
