    ...
    if (rod_series_1.includes(r_11)){
        ...
        var show_direction_h = {
            ...
            on_finish: function(data){
                jsPsych.data.addProperties({order: "high-low", environment: "high", price_displayed: "", 
        ...
        r_11 = r_11 + 1;
          ...
          var fishing_h = {
            ...
            background_spec_repeat: 'no-repeat',
            background_spec_position: 'center center',
            trial_duration: rem_11[counter_time_1],
            on_finish: function(data){
                jsPsych.data.addProperties({order: "high-low", environment: "high", price_displayed: price_recorded, 
          ...
          var loop_node_h = {
              ...
              loop_function: function(data){
                  if(Date.now() - block_start_time < block_length){
                      ...
                      rem_11.push(re_time);
                      counter_time_1 = counter_time_1 + 1;
                      console.log(counter_time_1)
                      return true;
                  } else {
                      return false;
                  }
  ...
  for(var i=0; i<n_blocks; i++){
    if (rod_series_2.includes(r_21)){
        ...
        var rod_fixing_first_h = {
            ...
            on_finish: function(data){
                jsPsych.data.addProperties({order: "high-low", environment: "high", price_displayed: "", 
                                            round_instance: "21", task: "rod_fixing", function_id: "rod_fixing_first_h",
                                            rod_fixing_checked: quality_check});
                if (data.key_press == 39){
                    s = s + 1;
                    return s;
  ...
  for(var i=0; i<n_blocks; i++){
      if (rod_series_1.includes(r_12)){
          ...
          var show_direction_l = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({order: "high-low", environment: "low", price_displayed: "", 
          ...
          var rod_fixing_first_l = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({order: "high-low", environment: "low", price_displayed: "", 
                                            round_instance: "12", task: "rod_fixing", function_id: "rod_fixing_first_l",
                                            rod_fixing_checked: quality_check});
                  if (data.key_press == 39){
                      n = n + 1;
                      return n;
    ...
    on_finish: function(data){
          ...
          var fishing_l = {
            ...
            background_spec_repeat: 'no-repeat',
            background_spec_position: 'center center',
            trial_duration: rem_12[counter_time],
            on_finish: function(data){
                jsPsych.data.addProperties({order: "high-low", environment: "low", price_displayed: price_recorded, 
                                            round_instance: "12", task: "", function_id: "fishing_l",
                                            rod_fixing_checked: ""});
            }
        }
          var loop_node_l = {
    ...
    if (rod_series_2.includes(r_22)){
        // do rod
          ...
          var rod_fixing_first_l = {
              ...
              on_finish: function(data){
                  jsPsych.data.addProperties({order: "high-low", environment: "low", price_displayed: "", 
                                            round_instance: "22", task: "rod-fixing", function_id: "rod_fixing_first_l",
                                            rod_fixing_checked: quality_check});
                  if (data.key_press == 39){
                      n = n + 1;
                      return n;
