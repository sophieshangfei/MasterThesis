...
jsPsych.plugins['fishings'] = (function(){
  ...
  plugin.trial = function(display_element, trial) {
      ...
      var new_html = '<img src="'+trial.stimulus+'" id="jspsych-max-keyboard"></img>';
      ...
      function doFeedback(correct) {
          ...
          if (trial.show_stim_with_feedback) {
  			if (correct) {
  				...
  				display_element.innerHTML = '<img id="jspsych-fishing" class="jspsych-fishing" src="'+trial.unfished_feedback+'"></img>';
  			}
        } 
